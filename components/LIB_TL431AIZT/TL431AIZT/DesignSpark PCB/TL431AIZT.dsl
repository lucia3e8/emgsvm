...
(library Library_1
	...
	(patternDef "TL431AIZT" (originalName "TL431AIZT")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.271, 0.525) (textStyleRef "Default") (isVisible True))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt 1.27 -1.35) (pt -1.08 -1.35) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.08 -1.35) (pt -1.08 0.05) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.08 0.05) (pt -1.08 0.05) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.2705, 0.05) (radius 2.3505) (startAngle 180) (sweepAngle -181.2) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.62 0) (pt 3.62 -1.35) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.62 -1.35) (pt 1.27 -1.35) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "TL431AIZT" (originalName "TL431AIZT") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(attr "Datasheet Link" "https://www.st.com/resource/en/datasheet/tl431.pdf")
		(attr "Height" "4.4 mm")
	)
