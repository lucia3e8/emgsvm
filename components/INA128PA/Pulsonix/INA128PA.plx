...
(library Library_1
	...
	(compDef "INA128PA" (originalName "INA128PA") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "RG_1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "RG_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/ina128.pdf")
		(attr "<Component Height>" "5.08")
		(attr "<STEP Filename>" "INA128PA.stp")
